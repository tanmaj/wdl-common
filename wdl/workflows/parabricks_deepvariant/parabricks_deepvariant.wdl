...
workflow parabricks_deepvariant {
  ...
  input {
    ...
    String parabricks_version = "4.6.0-2"

    RuntimeAttributes default_runtime_attributes
  }

  String parabricks_docker_image = if (default_runtime_attributes.backend == "AWS-HealthOmics") then default_runtime_attributes.container_registry else "nvcr.io/nvidia/clara" + "/clara-parabricks:~{parabricks_version}"
  ...
  call run_parabricks_deepvariant {
    input:
      ...
      ref_index          = ref_index,
      ref_name           = ref_name,
      docker_image       = parabricks_docker_image,
...
task run_parabricks_deepvariant {
  ...
  parameter_meta {
    ...
    docker_image: {
      name: "Parabricks Docker image URL"
    }
    runtime_attributes: {
